...
const DetailsPR = () => {
    ...
    const carriageType = [
        ...
        { label: 'Carriage Details', value: 'Standard' },
        { label: 'Delivery Type', value: 'Installation' },
    ];

    const railType = [
        { label: 'Rail Kit Type', value: 'Infinity' },
        { label: 'Rail Colour', value: 'White' },
        { label: 'Lower Start Type', value: 'Standard' },
        { label: 'Upper Finish Type', value: 'Standard' },
    ];
    ...
    return (
        <div className="detailsPR">
            <div className="grid">
                ...
                <DetailsBox title="Carriage Type" items={carriageType} />
                <DetailsBox title="Rail Type" items={railType} />
